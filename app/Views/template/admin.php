...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('/asset') ?>/css/datatable.css">
    ...
    <!-- Sweet Alert -->
    <link rel="stylesheet" href="<?= base_url('/asset/admin') ?>/plugins/node_modules/sweetalert2/dist/sweetalert2.min.css">
    ...
    <script src="<?= base_url('/asset/admin') ?>/plugins/node_modules/sweetalert2/dist/sweetalert2.all.min.js"></script>
</head>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link user-menu" data-toggle="dropdown" href="javascript:void(0)">
                        <!-- <i class="far fa-user"></i> -->
                        <div class="image gambar-user">
